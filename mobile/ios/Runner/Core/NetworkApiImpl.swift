...
class NetworkApiImpl: NetworkApi {
  ...
  func configureCertificatePinning(rootCertificatesBase64: [String]) throws {
    NetworkCertificatePinning.shared.configureRoots(rootCertificatesBase64)
  }

  func registerTrustedChain(host: String, chainCertificatesBase64: [String]) throws {
    NetworkCertificatePinning.shared.registerHostChain(host: host, chainCertificatesBase64: chainCertificatesBase64)
  }
