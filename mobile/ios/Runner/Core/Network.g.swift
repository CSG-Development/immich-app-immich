...
class NetworkApiSetup {
  ...
  static func setUp(binaryMessenger: FlutterBinaryMessenger, api: NetworkApi?, messageChannelSuffix: String = "") {
    ...
    let addCertificateChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.personal_cloud_photos.NetworkApi.addCertificate\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let selectCertificateChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.personal_cloud_photos.NetworkApi.selectCertificate\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let removeCertificateChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.personal_cloud_photos.NetworkApi.removeCertificate\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let hasCertificateChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.personal_cloud_photos.NetworkApi.hasCertificate\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let getClientPointerChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.personal_cloud_photos.NetworkApi.getClientPointer\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let setRequestHeadersChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.personal_cloud_photos.NetworkApi.setRequestHeaders\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    if let api = api {
      configureCertificatePinningChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
        let rootCertificatesBase64Arg = args[0] as! [String]
        do {
          try api.configureCertificatePinning(rootCertificatesBase64: rootCertificatesBase64Arg)
          reply(wrapResult(nil))
        } catch {
          reply(wrapError(error))
        }
    ...
    if let api = api {
      registerTrustedChainChannel.setMessageHandler { message, reply in
        ...
        let chainCertificatesBase64Arg = args[1] as! [String]
        do {
          try api.registerTrustedChain(host: hostArg, chainCertificatesBase64: chainCertificatesBase64Arg)
          reply(wrapResult(nil))
        } catch {
          reply(wrapError(error))
        }
      ...
      registerTrustedChainChannel.setMessageHandler(nil)
    }
    let unregisterTrustedChainChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.personal_cloud_photos.NetworkApi.unregisterTrustedChain\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      unregisterTrustedChainChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
        let hostArg = args[0] as! String
        do {
          try api.unregisterTrustedChain(host: hostArg)
          reply(wrapResult(nil))
        } catch {
          reply(wrapError(error))
        }
    ...
    let getAppGroupIdChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.personal_cloud_photos.NetworkApi.getAppGroupId\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
