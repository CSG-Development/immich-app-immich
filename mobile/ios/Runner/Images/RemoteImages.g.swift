...
class RemoteImageApiSetup {
  ...
  static func setUp(binaryMessenger: FlutterBinaryMessenger, api: RemoteImageApi?, messageChannelSuffix: String = "") {
    ...
    let requestImageChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.personal_cloud_photos.RemoteImageApi.requestImage\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let cancelRequestChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.personal_cloud_photos.RemoteImageApi.cancelRequest\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let clearCacheChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.personal_cloud_photos.RemoteImageApi.clearCache\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
