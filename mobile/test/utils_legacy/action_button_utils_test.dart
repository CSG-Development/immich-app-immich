...
void main() {
  ...
  group('ActionButtonType.shouldShow', () {
    ...
    group('deletePermanent button', () {
      ...
      test('should show when asset is trashed outside trash timeline', () {
        final remoteAsset = createRemoteAsset(deletedAt: DateTime(2024));
        final context = ActionButtonContext(
          asset: remoteAsset,
          isOwner: true,
      ...
      test('should show when in locked view for owner remote asset', () {
        final remoteAsset = createRemoteAsset();
        final context = ActionButtonContext(
          asset: remoteAsset,
          isOwner: true,
          ...
          isStacked: false,
          source: ActionSource.viewer,
          timelineOrigin: TimelineOrigin.lockedFolder,
        );
