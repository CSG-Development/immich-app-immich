...
interface ViewIntentHostApi {
  ...
  companion object {
    ...
    fun setUp(binaryMessenger: BinaryMessenger, api: ViewIntentHostApi?, messageChannelSuffix: String = "") {
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.personal_cloud_photos.ViewIntentHostApi.consumeViewIntent$separatedMessageChannelSuffix", codec)
        if (api != null) {
