...
private object ClipboardPigeonUtils {
...
data class ClipboardPhoto (
...
)
 {
  ...
  override fun equals(other: Any?): Boolean {
    ...
    return ClipboardPigeonUtils.deepEquals(toList(), other.toList())  }
...
private open class ClipboardPigeonCodec : StandardMessageCodec() {
        ...
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            ...
            val wrapped: List<Any?> = try {
              ...
              ClipboardPigeonUtils.wrapError(exception)
            }
            reply.reply(wrapped)
          }
        } else {
