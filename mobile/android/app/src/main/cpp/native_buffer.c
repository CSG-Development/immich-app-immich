...
Java_com_seagate_curator_stxphotos_android_NativeBuffer_allocate(
...
Java_com_seagate_curator_stxphotos_android_NativeBuffer_free(
        JNIEnv *env, jclass clazz, jlong address) {
    free((void *) address);
}

JNIEXPORT jlong JNICALL
Java_com_seagate_curator_stxphotos_android_NativeBuffer_realloc(
...
Java_com_seagate_curator_stxphotos_android_NativeBuffer_wrap(
        JNIEnv *env, jclass clazz, jlong address, jint capacity) {
    return (*env)->NewDirectByteBuffer(env, (void *) address, capacity);
}

JNIEXPORT void JNICALL
Java_com_seagate_curator_stxphotos_android_NativeBuffer_copy(
 ...
 */
JNIEXPORT jlong JNICALL
Java_com_seagate_curator_stxphotos_android_NativeBuffer_createGlobalRef(
