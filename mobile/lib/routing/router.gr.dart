...
class AssetViewerRouteArgs {
  ...
  @override
  String toString() {
    return 'AssetViewerRouteArgs{key: $key, initialIndex: $initialIndex, timelineService: $timelineService, heroOffset: $heroOffset, closeViewerWhenAssetLeavesTimeline: $closeViewerWhenAssetLeavesTimeline, currentAlbum: $currentAlbum}';
  }
  ...
  bool operator ==(Object other) {
    ...
    return key == other.key &&
        ...
        closeViewerWhenAssetLeavesTimeline ==
            other.closeViewerWhenAssetLeavesTimeline &&
...
class CuratorOnboardingRoute extends PageRouteInfo<void> {
  const CuratorOnboardingRoute({List<PageRouteInfo>? children})
    : super(CuratorOnboardingRoute.name, initialChildren: children);

  static const String name = 'CuratorOnboardingRoute';

  static PageInfo page = PageInfo(
    name,
    builder: (data) {
      return const CuratorOnboardingPage();
    },
  );
}
...
class DriftPeopleMergeRouteArgs {
  ...
  bool operator ==(Object other) {
    if (identical(this, other)) return true;
    if (other is! DriftPeopleMergeRouteArgs) return false;
...
class PasscodeLockRouteArgs {
  ...
  bool operator ==(Object other) {
    if (identical(this, other)) return true;
    if (other is! PasscodeLockRouteArgs) return false;
    return key == other.key &&
        flow == other.flow &&
  ...
  @override
  int get hashCode => key.hashCode ^ flow.hashCode ^ onSuccess.hashCode;
}
...
class PatternLockRouteArgs {
  ...
  bool operator ==(Object other) {
    if (identical(this, other)) return true;
    if (other is! PatternLockRouteArgs) return false;
    return key == other.key &&
        flow == other.flow &&
        onSuccess == other.onSuccess;
  }
...
class UnableToConnectRouteArgs {
  ...
  bool operator ==(Object other) {
    if (identical(this, other)) return true;
    if (other is! UnableToConnectRouteArgs) return false;
...
class UnableToDetectRouteArgs {
  ...
  bool operator ==(Object other) {
    if (identical(this, other)) return true;
    if (other is! UnableToDetectRouteArgs) return false;
    return key == other.key && onRetry == other.onRetry;
  }
