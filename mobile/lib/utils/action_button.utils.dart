...
import 'package:immich_mobile/presentation/widgets/action_buttons/airplay_action_button.widget.dart';
...
enum ActionButtonType {
  ...
  bool shouldShow(ActionButtonContext context) {
    return switch (this) {
      ...
      ActionButtonType.airplay => Platform.isIOS,
  ...
  Widget buildButton(
    ...
    return switch (this) {
      ...
      ActionButtonType.copy => CopyActionButton(source: context.source, menuItem: menuItem),
      ...
      ActionButtonType.airplay => AirplayActionButton(iconOnly: iconOnly, menuItem: menuItem),
    };
  }
