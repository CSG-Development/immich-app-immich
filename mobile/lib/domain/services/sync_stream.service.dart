...
class SyncStreamService {
  ...
  Future<void> _runPreSyncTasks(List<String> migrations, SemVer semVer) async {
    ...
    if (!migrations.contains(SyncMigrationTask.v20260128_ResetAssetV1.name) && semVer.isAtLeastV1_31) {
    ...
    if (!migrations.contains(SyncMigrationTask.v20260597_ResetAssetV1AssetV2.name) && semVer.isAtLeastImmich3) {
