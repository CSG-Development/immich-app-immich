...
final _assetByRemoteIdProvider = FutureProvider.autoDispose.family<legacy.Asset?, String>((ref, remoteId) async {
    ...
    void addTag() async {
      try {
        ...
        await api.tagsApi.bulkTagAssets(
          TagBulkAssetsDto(assetIds: [remoteId], tagIds: pickedTags.map((t) => t.id).toList()),
        );
