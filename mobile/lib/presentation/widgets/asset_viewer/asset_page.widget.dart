...
class AssetPage extends ConsumerStatefulWidget {
  ...
  final BaseAsset? fallbackAsset;
  final void Function(int direction)? onTapNavigate;

  const AssetPage({super.key, required this.index, required this.heroOffset, this.fallbackAsset, this.onTapNavigate});
...
class _AssetPageState extends ConsumerState<AssetPage> {
  ...
  void initState() {
    ...
    _asset = ref.read(timelineServiceProvider).getAssetSafe(widget.index) ?? widget.fallbackAsset;
  ...
  Widget build(BuildContext context) {
    ...
    final asset = _asset ?? widget.fallbackAsset;
    if (asset == null) {
