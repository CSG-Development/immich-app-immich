...
class LocalFullImageProvider extends CancellableImageProvider<LocalFullImageProvider>
  ...
  ImageStreamCompleter loadImage(LocalFullImageProvider key, ImageDecoderCallback decode) {
    ...
    return OneFramePlaceholderImageStreamCompleter(
      ...
      initialImage: key.originalOnly ? null : getInitialImage(LocalThumbProvider(id: key.id, assetType: key.assetType)),
      informationCollector: () => <DiagnosticsNode>[
        DiagnosticsProperty<ImageProvider>('Image provider', this),
        DiagnosticsProperty<String>('Id', key.id),
        DiagnosticsProperty<Size>('Size', key.size),
  ...
  bool operator ==(Object other) {
    ...
    if (other is LocalFullImageProvider) {
      return id == other.id &&
          ...
          originalOnly == other.originalOnly;
    }
    return false;
  }

  @override
  int get hashCode => id.hashCode ^ size.hashCode ^ isAnimated.hashCode ^ originalOnly.hashCode;
}
