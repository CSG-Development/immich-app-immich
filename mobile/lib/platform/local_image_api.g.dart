...
class LocalImageApi {
  ...
  Future<Map<String, int>?> requestImage(
    ...
    final pigeonVar_channelName =
        'dev.flutter.pigeon.personal_cloud_photos.LocalImageApi.requestImage$pigeonVar_messageChannelSuffix';
  ...
  Future<void> cancelRequest(int requestId) async {
    final pigeonVar_channelName =
        'dev.flutter.pigeon.personal_cloud_photos.LocalImageApi.cancelRequest$pigeonVar_messageChannelSuffix';
    final pigeonVar_channel = BasicMessageChannel<Object?>(
      pigeonVar_channelName,
      pigeonChannelCodec,
      binaryMessenger: pigeonVar_binaryMessenger,
  ...
  Future<Map<String, int>> getThumbhash(String thumbhash) async {
    final pigeonVar_channelName =
        'dev.flutter.pigeon.personal_cloud_photos.LocalImageApi.getThumbhash$pigeonVar_messageChannelSuffix';
    final pigeonVar_channel = BasicMessageChannel<Object?>(
      pigeonVar_channelName,
      pigeonChannelCodec,
      binaryMessenger: pigeonVar_binaryMessenger,
