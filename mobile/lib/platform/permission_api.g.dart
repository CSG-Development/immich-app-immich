...
class PermissionApi {
  ...
  Future<PermissionStatus> isIgnoringBatteryOptimizations() async {
    final pigeonVar_channelName =
        'dev.flutter.pigeon.personal_cloud_photos.PermissionApi.isIgnoringBatteryOptimizations$pigeonVar_messageChannelSuffix';
  ...
  Future<bool> hasManageMediaPermission() async {
    final pigeonVar_channelName =
        'dev.flutter.pigeon.personal_cloud_photos.PermissionApi.hasManageMediaPermission$pigeonVar_messageChannelSuffix';
    final pigeonVar_channel = BasicMessageChannel<Object?>(
      pigeonVar_channelName,
      pigeonChannelCodec,
      binaryMessenger: pigeonVar_binaryMessenger,
  ...
  Future<bool> requestManageMediaPermission() async {
    final pigeonVar_channelName =
        'dev.flutter.pigeon.personal_cloud_photos.PermissionApi.requestManageMediaPermission$pigeonVar_messageChannelSuffix';
    final pigeonVar_channel = BasicMessageChannel<Object?>(
      pigeonVar_channelName,
      pigeonChannelCodec,
      binaryMessenger: pigeonVar_binaryMessenger,
  ...
  Future<bool> manageMediaPermission() async {
    final pigeonVar_channelName =
        'dev.flutter.pigeon.personal_cloud_photos.PermissionApi.manageMediaPermission$pigeonVar_messageChannelSuffix';
    final pigeonVar_channel = BasicMessageChannel<Object?>(
      pigeonVar_channelName,
      pigeonChannelCodec,
      binaryMessenger: pigeonVar_binaryMessenger,
