...
class NetworkApi {
  ...
  Future<void> cancelInFlightHttpRequests() async {
    final pigeonVar_channelName =
        'dev.flutter.pigeon.personal_cloud_photos.NetworkApi.cancelInFlightHttpRequests$pigeonVar_messageChannelSuffix';
    final pigeonVar_channel = BasicMessageChannel<Object?>(
      pigeonVar_channelName,
      pigeonChannelCodec,
      binaryMessenger: pigeonVar_binaryMessenger,
  ...
  Future<void> recreateSession() async {
    final pigeonVar_channelName =
        'dev.flutter.pigeon.personal_cloud_photos.NetworkApi.recreateSession$pigeonVar_messageChannelSuffix';
    final pigeonVar_channel = BasicMessageChannel<Object?>(
      pigeonVar_channelName,
      pigeonChannelCodec,
      binaryMessenger: pigeonVar_binaryMessenger,
  ...
  Future<String> getAppGroupId() async {
    final pigeonVar_channelName =
        'dev.flutter.pigeon.personal_cloud_photos.NetworkApi.getAppGroupId$pigeonVar_messageChannelSuffix';
    final pigeonVar_channel = BasicMessageChannel<Object?>(
      pigeonVar_channelName,
      pigeonChannelCodec,
      binaryMessenger: pigeonVar_binaryMessenger,
