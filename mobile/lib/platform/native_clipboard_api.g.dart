...
class ClipboardPhoto {
  ClipboardPhoto({required this.filePath, required this.fileName, required this.fileSize, required this.mimeType});
  ...
  List<Object?> _toList() {
    return <Object?>[filePath, fileName, fileSize, mimeType];
  }
...
class ClipboardResult {
  ClipboardResult({required this.success, this.error, required this.photoCount});
  ...
  List<Object?> _toList() {
    return <Object?>[success, error, photoCount];
  }
  ...
  static ClipboardResult decode(Object result) {
    result as List<Object?>;
    return ClipboardResult(success: result[0]! as bool, error: result[1] as String?, photoCount: result[2]! as int);
  }
