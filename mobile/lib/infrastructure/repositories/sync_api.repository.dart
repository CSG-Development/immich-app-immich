...
class SyncApiRepository {
  ...
  Future<void> streamChanges(
    ...
    final isV1_31 = serverVersion.isAtLeastV1_31;
    final isImmich3 = serverVersion.isAtLeastImmich3;
    request.body = jsonEncode(
      SyncStreamDto(
        types: [
          SyncRequestType.authUsersV1,
          SyncRequestType.usersV1,
          isImmich3 ? SyncRequestType.assetsV2 : SyncRequestType.assetsV1,
          SyncRequestType.assetExifsV1,
          if (isV1_31) SyncRequestType.assetEditsV1,
          SyncRequestType.assetMetadataV1,
          SyncRequestType.partnersV1,
          isImmich3 ? SyncRequestType.partnerAssetsV2 : SyncRequestType.partnerAssetsV1,
          SyncRequestType.partnerAssetExifsV1,
          if (isImmich3) SyncRequestType.albumsV2 else SyncRequestType.albumsV1,
          SyncRequestType.albumUsersV1,
          isImmich3 ? SyncRequestType.albumAssetsV2 : SyncRequestType.albumAssetsV1,
          ...
          isV1_31 ? SyncRequestType.assetFacesV2 : SyncRequestType.assetFacesV1,
          if (isImmich3) SyncRequestType.assetOcrV1,
        ],
      ).toJson(),
    );
