...
class _AnimalMaskOverlay extends StatelessWidget {
  const _AnimalMaskOverlay({
    required this.mask,
...
class _AnimalMaskPainter extends CustomPainter {
  _AnimalMaskPainter({
    required this.mask,
    required this.displayWidth,
    required this.displayHeight,
  ...
  @override
  bool shouldRepaint(covariant _AnimalMaskPainter oldDelegate) {
