...
<div
  id="face-editor-data"
  class="absolute start-0 top-0 z-5 size-full overflow-hidden"
...
>
  <canvas bind:this={canvasEl} id="face-editor" class="absolute start-0 top-0"></canvas>

  <div
    id="face-selector"
    bind:this={faceSelectorEl}
    class="absolute start-[calc(50%-125px)] top-[calc(50%-250px)] w-62.5 max-w-62.5 rounded-xl border border-gray-200 bg-white px-2 py-4 backdrop-blur-sm transition-[top,left] duration-200 ease-out dark:border-gray-800 dark:bg-immich-dark-gray dark:text-immich-dark-fg"
  >
