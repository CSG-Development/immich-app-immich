        ...
        {#each peopleWithFaces as face, index (face.id)}
          ...
          <div class="relative h-29 w-24">
            <div
              role="button"
              tabindex={index}
              class="absolute start-0 top-0 size-22.5 cursor-default"
            ...
            >
              ...
              <div class="absolute end-[-3px] top-[-3px] size-5 rounded-full">
                {#if selectedPersonToCreate[face.id] || selectedPersonToReassign[face.id]}
                  <IconButton
                    ...
                    aria-label={$t('reset')}
                    size="small"
                    class="absolute start-1/2 top-1/2 translate-[-50%] transform"
              ...
              <div class="absolute end-8 top-[-3px] size-5 rounded-full">
                {#if !Object.hasOwn(selectedPersonToCreate, face.id) && !Object.hasOwn(selectedPersonToReassign, face.id) && !face.person}
                  <div
                    class="absolute start-1/2 top-1/2 flex translate-[-50%] transform place-content-center place-items-center rounded-full bg-[#d3d3d3] p-1 transition-all"
                  >
              ...
              {#if face.person != null}
                <div class="absolute end-[-3px] top-8 size-5 rounded-full">
                  <IconButton
                    shape="round"
                    color="danger"
                    icon={mdiTrashCan}
