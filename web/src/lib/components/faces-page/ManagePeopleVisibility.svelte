<script lang="ts">
  ...
  import PeopleInfiniteScroll from '../../../routes/(user)/people/PeopleInfiniteScroll.svelte';
  ...
  >
    <div class="flex items-center w-full">
      ...
      <div class="flex gap-2 items-center">
        <p id={titleId} class="ms-2 w-25 md:w-full font-medium">{$t('show_and_hide_people')}</p>
