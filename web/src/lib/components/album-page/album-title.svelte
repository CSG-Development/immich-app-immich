...
<input
  ...
  class="w-[99%] border-b-2 border-transparent text-[34px] md:text-5xl text-primary outline-none transition-all {isOwned
    ? 'hover:border-gray-400'
    : 'hover:border-transparent'} focus:outline-none placeholder:text-primary/90"
  type="text"
