...
<tr
  class="flex h-[44px] w-full place-items-center border-[3px] border-transparent p-2 text-center even:bg-immich-bg-gray/75 odd:bg-white hover:cursor-pointer hover:border-immich-primary/75 odd:dark:bg-immich-dark-gray/75 even:dark:bg-immich-dark-gray/50 dark:hover:border-immich-dark-primary/75 md:p-5"
