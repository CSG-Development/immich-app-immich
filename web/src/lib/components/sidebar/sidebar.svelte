...
<nav
  ...
  tabindex="-1"
  class="immich-scrollbar relative z-1 w-0 sidebar:w-[18.75rem] overflow-y-auto overflow-x-hidden pt-8 transition-all duration-200 bg-light"
...
>
  <div class="pe-4 flex flex-col gap-1 h-max min-h-full">
    {@render children?.()}
  </div>
</nav>
