      ...
      <div class="grid gap-4 grid-cols-1 lg:grid-cols-2 w-full">
        ...
        <div class="col-span-full">
          <div class="flex flex-col lg:flex-row gap-4 w-full">
            <ServerStatisticsCard icon={mdiCameraIris} title={$t('photos')} valuePromise={{ value: userStatistics.images }} />
            <ServerStatisticsCard icon={mdiPlayCircle} title={$t('videos')} valuePromise={{ value: userStatistics.videos }} />
            <ServerStatisticsCard
              icon={mdiChartPie}
              title={$t('storage')}
              valuePromise={{ value: statsUsage, unit: statsUsageUnit }}
            />
          </div>
        </div>
